...
export const Navbar: React.FC = () => {
  ...
  return (
    <motion.nav 
      ...
      className={`fixed top-0 left-0 w-full px-6 md:px-16 py-4 flex items-center justify-between z-50 transition-all duration-300 ${
        isScrolled 
    ...
    >
      <div className="flex items-center gap-3">
        {/* Logo 81 */}
        <div className="w-10 h-10 bg-[#cc3333] rounded-full flex items-center justify-center text-white font-black text-lg shadow-sm">
          81
        </div>
